...
<div class="container py-4">
    <div class="bg-dark text-white p-4 rounded-top mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h3 mb-0 fw-bold">Gestión de Países</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 bg-transparent p-0">
                        <li class="breadcrumb-item active text-light" aria-current="page">Países</li>
                    </ol>
                </nav>
            </div>
            <a href="{{ route('countries.create') }}" class="btn btn-outline-light">
            ...
            <div class="row g-3 align-items-center">
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="searchCountry" placeholder="Buscar país...">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card shadow">
        <div class="card-header bg-dark text-white py-3">
            <h5 class="mb-0 fw-bold">Lista de Países</h5>
        </div>
        <div class="card-body">
            @if(session('success'))
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-center">
                        <div class="mb-4">
                            <i class="fas fa-globe text-danger" style="font-size: 4rem;"></i>
                        </div>
                        <p style="font-size: 1.1rem; margin-bottom: 0.5rem;">
                            Si eliminas este país, también se eliminarán todas las ciudades asociadas. País:
                        </p>
